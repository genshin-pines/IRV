...
__all__ = ["alerts_router", "auth_router", "ws_manager", "cameras_router", "custom_gestures_router", "gesture_router", "mobile_camera_router", "music_router", "plate_router", "preferences_router", "traffic_police_router"]
